...
background-image: url(images/wansink-bowl.jpeg)
...
Wansink resigned in 2018.
]

---
# Modern scientific tools have consequences
.pull-left[
![](images/science-gene-errors.png)
]

.pull-right[
![](images/ziemann-abstract.png)
]
...
---
.footnote[Sterling, 1959; Cohen, 1962; Lykken, 1968; Tukey, 1969; Greenwald, 1975; Meehl, 1978; Rosenthal, 1979
]
...
# Core Problem:
## Weak Scientific Integrity

# Things that *can* help

## Design (Preregistration, Reporting)
## Reproducible Workflow
## Dissemination

---
.footnote[Malley et al. *Society & Natural Resources* (2011)]
...
.pull-right[
"The results provide evidence for environmental racism with regard to whether or not a fine was assessed; however, the amount of fine assessed appears unrelated to the racial and economic structure of the places where violations occurred."
]
...
---
"We had a bunch of zeros that should have been coded ones and the ones should have been coded zeroes. We let the editors know that there was a coding error. It was a pretty significant one and we felt stupid and embarrassed."

When the researchers recalculated the incorrect data in the table originally included
in the online version, the conclusions were flipped

---
.footnote[ *Am Econ Rev* (2012)]

.center[
![:scale 30%](fisher-aer-title.png)
]

.right-column[
We present evidence showing that the differences stem mainly from three sources:
...
![](greenstone-aer-reply.png)

---
Ask yourself: what % of papers are even posting code?
...
.center[
# .white[x]
# .red[**This entire conversation was an email.**]
]
...
# You said they won't get published!
...
knitr::include_graphics("images/munafo-figure.png")
```
...
knitr::include_graphics("images/steen-2013.png")
```
]
...
````{r, echo=F, out.width=700}
knitr::include_graphics("images/chavalarais-fig3.png")
```
]
...
---
![](images/truth-vigilantes-soccer-calls2.png)
...
knitr::include_graphics("images/turner-nejm-fig.png")
```
]]
...
.right-column[
.center[
![:scale 65%](images/mervis-franco-fig.png)
]]
...
.center[
```{r,  echo=F, out.width = 650}
knitr::include_graphics("images/nosek-fig.png") 
```
]
...
.pull-right[
![](images/gertler-replication.jpg)
]
...
---
# Summary points: Why Embrace Reproducible Research?
1. For Science.
2. For Your Research.
